...
That rebuilds with `--preview` (live slots from `artifacts/prose/slots/`), copies `prototype/dist` into this repo (plus `.nojekyll` + this README), commits, and pushes to `main`. No Fallback/AI overlay.
